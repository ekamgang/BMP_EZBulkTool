...
namespace BMP_EZBulkTool
{
    class MailingService
    {
        ...
        private static readonly char[] PreCombined = Convert.ToBase64String(Encoding.ASCII.GetBytes(""), Base64FormattingOptions.None).ToCharArray(); //KEY
